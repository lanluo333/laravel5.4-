        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    ...
                    <a href="#" class="blog-nav-item dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> {{(!Auth::user())?'not name' : Auth::user()->name}}  <span class="caret"></span></a>
